...
async function setupScene() {
  ...
  let vertSource = await loadNetworkResourceAsText('resources/shaders/verts/rainbowshad.vert');
  let fragSource = await loadNetworkResourceAsText('resources/shaders/frags/rainbowshad.frag');
