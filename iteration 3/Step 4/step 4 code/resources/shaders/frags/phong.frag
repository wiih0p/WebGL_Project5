...
void main() {
  ...
  //same as the step3 phong but adding these calculations to increase the red value by changing the y axis
  float red = (vPosition.y + 1.0) / 2.0;
  vec3 redmax = vec3((1.0 - red), 1.0, 1.0);
  vec3 redmin = vec3(red, 0.0, 0.0);
