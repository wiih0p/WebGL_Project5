...
async function setupScene() {
  ...
  let vertSource = await loadNetworkResourceAsText('resources/shaders/verts/tex_gouraud.vert');
  let fragSource = await loadNetworkResourceAsText('resources/shaders/frags/tex_gouraud.frag');
...
function drawScene(deltaTime) {
  ...
  //load the texture
  loadTexture("resources/textures/yote.png");
