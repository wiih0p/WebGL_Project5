...
async function setupScene() {
  let objData = await loadNetworkResourceAsText('resources/models/vtsphere.obj');
  let vertSource = await loadNetworkResourceAsText('resources/shaders/verts/texcheck.vert');
  let fragSource = await loadNetworkResourceAsText('resources/shaders/frags/texcheck.frag');
...
function drawScene(deltaTime) {
  ...
  //make a array for the cubemap
  let cubemap = [];
  //if the faces are in order use this
  //for (var i = 1; i < 7; i++){
  
  //  cubemap[i] = "resources/textures/cubemap/plate" + i + ".bmp";
  //  console.log(cubemap[i]);
  //}
  
  //if faces are out of order do manually
  cubemap[1] = "resources/textures/cubemap/plate4.bmp";
  cubemap[2] = "resources/textures/cubemap/plate2.bmp";
  cubemap[3] = "resources/textures/cubemap/plate1.bmp";
  cubemap[4] = "resources/textures/cubemap/plate6.bmp";
  cubemap[5] = "resources/textures/cubemap/plate3.bmp";
  cubemap[6] = "resources/textures/cubemap/plate5.bmp";

/*
  cubemap[1] = "resources/textures/coitMap/posx.jpg";
  cubemap[2] = "resources/textures/coitMap/negx.jpg";
  cubemap[3] = "resources/textures/coitMap/posy.jpg";
  cubemap[4] = "resources/textures/coitMap/negy.jpg";
  cubemap[5] = "resources/textures/coitMap/posz.jpg";
  cubemap[6] = "resources/textures/coitMap/negz.jpg";
  */
  //load the texture
  loadTexture(cubemap);
