...
async function setupScene() {
  ...
  let vertSource = await loadNetworkResourceAsText('resources/shaders/verts/tex_step3.vert');
  let fragSource = await loadNetworkResourceAsText('resources/shaders/frags/tex_step3.frag');
