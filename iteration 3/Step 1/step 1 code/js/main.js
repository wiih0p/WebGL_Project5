...
// some calls didnt work like image.onload so mostly just took that out
...
async function setupScene() {
  let objData = await loadNetworkResourceAsText('resources/models/vtcube.obj');
  let vertSource = await loadNetworkResourceAsText('resources/shaders/verts/tex.vert');
  let fragSource = await loadNetworkResourceAsText('resources/shaders/frags/tex.frag');
...
function drawScene(deltaTime) {
  ...
  //load the texture
  loadTexture("resources/textures/yeet.png");
